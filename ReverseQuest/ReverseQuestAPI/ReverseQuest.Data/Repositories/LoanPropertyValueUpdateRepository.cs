...
{
    public class LoanPropertyValueUpdateRepository : IRepositoryForPrimitiveTypes<int>
    {
        private readonly ReverseQuestEntities _reverseQuestEntities;
        private bool _disposed;

        public LoanPropertyValueUpdateRepository(ReverseQuestEntities reverseQuestEntities)
        {
        ...
        {
            return _reverseQuestEntities.usp_UpdatePropertyValue(
                parameters["ai_PropertyValueSkey"] as int?,
