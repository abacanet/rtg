...
{
    public class LoanSearchRepository : IRepository<usp_GetResultsLoanSearch_Result>
    {
        private readonly ReverseQuestEntities _reverseQuestEntities;
        private bool _disposed;

        public LoanSearchRepository(ReverseQuestEntities reverseQuestEntities)
        {
        ...
        public IQueryable<usp_GetResultsLoanSearch_Result> GetAll()
        {
            throw new NotImplementedException();
        }

        public ObjectResult<usp_GetResultsLoanSearch_Result> ExecuteFunctionGet(params object[] ids)
        {
            throw new NotImplementedException();
        }

        public ObjectResult<usp_GetResultsLoanSearch_Result> GetCollectionByExecutingFunctionBasedOnParameters(IDictionary<string, object> parameters)
        {
            return _reverseQuestEntities.usp_GetResultsLoanSearch(
        ...
        public usp_GetResultsLoanSearch_Result GetEntityByExecutingFunctionBasedOnParameters(IDictionary<string, object> parameters)
        {
            throw new NotImplementedException();
        }

        public IQueryable<usp_GetResultsLoanSearch_Result> FindBy(Expression<Func<usp_GetResultsLoanSearch_Result, bool>> predicate)
        {
            throw new NotImplementedException();
        }

        public int Update(usp_GetResultsLoanSearch_Result entity, params object[] ids)
        {
            throw new NotImplementedException();
        }
