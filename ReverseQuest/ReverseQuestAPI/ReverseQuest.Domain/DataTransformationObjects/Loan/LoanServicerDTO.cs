...
{
    public class LoanServicerDTO : BaseDTO
    {
        ...
        public LoanServicerDTO MapFromEntity(usp_GetDetailsLoanDetails_Result entity)
        {
            return new LoanServicerDTO
            {
                ServicerName = entity.prior_servicer_name,
                MainPhoneNumber = entity.servicer_phone_number
            };
        }
    }
}