namespace ReverseQuest.BasicSamples.Repositories
{
    using Serenity.Data;
    ...
    public class CustomerGrossSalesRepository
    {
            ...
            CustomerGrossSalesListRequest request)
        {
            ...
            //var data = connection.Query<MyRow>("CustomerGrossSales", commandType: System.Data.CommandType.StoredProcedure);
