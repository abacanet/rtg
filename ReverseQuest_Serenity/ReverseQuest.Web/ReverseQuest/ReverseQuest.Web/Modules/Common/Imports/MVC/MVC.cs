...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Reversequest
        {
            public static class LoanSearchResults
            {
                public const string LoanSearchResultsIndex = "~/Modules/Reversequest/LoanSearchResults/LoanSearchResultsIndex.cshtml";
            }
        }
