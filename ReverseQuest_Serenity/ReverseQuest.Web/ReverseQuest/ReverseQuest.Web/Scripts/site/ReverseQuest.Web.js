...
(function (ReverseQuest) {
    ...
    })(Administration = ReverseQuest.Administration || (ReverseQuest.Administration = {}));
...
(function (ReverseQuest) {
    ...
    })(Authorization = ReverseQuest.Authorization || (ReverseQuest.Authorization = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Administration;
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        var ChartInDialog_1;
    })(BasicSamples = ReverseQuest.BasicSamples || (ReverseQuest.BasicSamples = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Northwind;
    (function (Northwind) {
        var ProductDialog = (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () {
                return ReverseQuest.LanguageList.getValue();
            };
    ...
    })(Northwind = ReverseQuest.Northwind || (ReverseQuest.Northwind = {}));
})(ReverseQuest || (ReverseQuest = {}));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(ReverseQuest.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(ReverseQuest.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        ReverseQuest.Common.ReportHelper.execute({
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: ReverseQuest.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: ReverseQuest.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new ReverseQuest.Northwind.OrderDialog();
                        ...
                        var chai = ReverseQuest.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = ReverseQuest.Northwind.EmployeeRow.getLookup().items
        ...
        }(ReverseQuest.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(ReverseQuest.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.OrderDialog));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    ReverseQuest.Northwind.CategoryService.Retrieve({
        ...
        }(ReverseQuest.Northwind.CategoryDialog));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(ReverseQuest.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new ReverseQuest.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                ReverseQuest.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(ReverseQuest.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    ReverseQuest.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(ReverseQuest.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(ReverseQuest.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    ReverseQuest.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return ReverseQuest.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return ReverseQuest.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return ReverseQuest.Northwind.OrderService.baseUrl; };
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.SupplierDialog));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(ReverseQuest.Northwind.SupplierGrid));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return ReverseQuest.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return ReverseQuest.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return ReverseQuest.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return ReverseQuest.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                ReverseQuest.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    ReverseQuest.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(ReverseQuest.Northwind.CustomerDialog));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.CustomerGrid));
...
(function (ReverseQuest) {
    ...
    })(Common = ReverseQuest.Common || (ReverseQuest.Common = {}));
})(ReverseQuest || (ReverseQuest = {}));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = ReverseQuest.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(ReverseQuest.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return ReverseQuest.Northwind.ProductRow.lookupKey;
            };
...
(function (ReverseQuest) {
    ...
    (function (Northwind) {
        ...
        }(ReverseQuest.Common.GridEditorBase));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Northwind.OrderDetailsEditor));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return ReverseQuest.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return ReverseQuest.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return ReverseQuest.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new ReverseQuest.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = ReverseQuest.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(ReverseQuest.Northwind.OrderDetailDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return ReverseQuest.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (ReverseQuest) {
    ...
    ReverseQuest.StaticTextBlock = StaticTextBlock;
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var BasicSamples;
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return ReverseQuest.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return ReverseQuest.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return ReverseQuest.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = ReverseQuest.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = ReverseQuest.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(ReverseQuest.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new ReverseQuest.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new ReverseQuest.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new ReverseQuest.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, ReverseQuest.Northwind.OrderRow.Fields.ShipCountry);
...
(function (ReverseQuest) {
    ...
    ReverseQuest.SelectableEntityGrid = SelectableEntityGrid;
})(ReverseQuest || (ReverseQuest = {}));
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return ReverseQuest.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return ReverseQuest.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return ReverseQuest.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(ReverseQuest.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = ReverseQuest.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            ReverseQuest.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return ReverseQuest.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return ReverseQuest.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return ReverseQuest.Northwind.ProductService.baseUrl; };
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return ReverseQuest.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return ReverseQuest.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return ReverseQuest.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: ReverseQuest.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return ReverseQuest.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return ReverseQuest.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return ReverseQuest.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (ReverseQuest) {
    ...
    ReverseQuest.BasicProgressDialog = BasicProgressDialog;
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new ReverseQuest.BasicProgressDialog();
...
(function (ReverseQuest) {
    ...
    })(DialogUtils = ReverseQuest.DialogUtils || (ReverseQuest.DialogUtils = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Common;
...
(function (ReverseQuest) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = ReverseQuest.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = ReverseQuest.LanguageList || (ReverseQuest.LanguageList = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Administration;
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return ReverseQuest.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = ReverseQuest.BasicSamples || (ReverseQuest.BasicSamples = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return ReverseQuest.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return ReverseQuest.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = ReverseQuest.BasicSamples || (ReverseQuest.BasicSamples = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return ReverseQuest.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return ReverseQuest.StaticTextBlock; }], ['FromLocalText', function () { return ReverseQuest.StaticTextBlock; }], ['DisplayFieldValue', function () { return ReverseQuest.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = ReverseQuest.BasicSamples || (ReverseQuest.BasicSamples = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
...
(function (ReverseQuest) {
    ...
    })(Meeting = ReverseQuest.Meeting || (ReverseQuest.Meeting = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Meeting;
...
(function (ReverseQuest) {
    ...
    })(Membership = ReverseQuest.Membership || (ReverseQuest.Membership = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Membership;
...
(function (ReverseQuest) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'ReverseQuest.Northwind.Entities.Gender');
    })(Northwind = ReverseQuest.Northwind || (ReverseQuest.Northwind = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
...
(function (ReverseQuest) {
    ...
    })(Organization = ReverseQuest.Organization || (ReverseQuest.Organization = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Organization;
...
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsForm = (function (_super) {
            __extends(LoanSearchResultsForm, _super);
            function LoanSearchResultsForm() {
                return _super.apply(this, arguments) || this;
            }
            return LoanSearchResultsForm;
        }(Serenity.PrefixedContext));
        LoanSearchResultsForm.formKey = 'Reversequest.LoanSearchResults';
        Reversequest.LoanSearchResultsForm = LoanSearchResultsForm;
        [['OriginalLoanNumber', function () { return Serenity.StringEditor; }], ['FhaCaseNumber', function () { return Serenity.StringEditor; }], ['PriorServicerLoanNumber', function () { return Serenity.StringEditor; }], ['InvestorLoanNumber', function () { return Serenity.StringEditor; }], ['LoanStatus', function () { return Serenity.StringEditor; }], ['LoanSubStatus', function () { return Serenity.StringEditor; }], ['BorrowerFirstName', function () { return Serenity.StringEditor; }], ['BorrowerMiddleName', function () { return Serenity.StringEditor; }], ['BorrowerLastName', function () { return Serenity.StringEditor; }], ['CoborrowerFirstName', function () { return Serenity.StringEditor; }], ['CoborrowerMiddleName', function () { return Serenity.StringEditor; }], ['CoborrowerLastName', function () { return Serenity.StringEditor; }], ['BorrowerPhoneNumber', function () { return Serenity.StringEditor; }], ['EnbsFirstName', function () { return Serenity.StringEditor; }], ['EnbsMiddleName', function () { return Serenity.StringEditor; }], ['EnbsLastName', function () { return Serenity.StringEditor; }], ['PropertyAddress1', function () { return Serenity.StringEditor; }], ['PropertyAddress2', function () { return Serenity.StringEditor; }], ['PropertyCity', function () { return Serenity.StringEditor; }], ['PropertyCounty', function () { return Serenity.StringEditor; }], ['PropertyState', function () { return Serenity.StringEditor; }], ['PropertyZipcode', function () { return Serenity.StringEditor; }], ['ServicerName', function () { return Serenity.StringEditor; }], ['InvestorName', function () { return Serenity.StringEditor; }], ['LoanPoolDescription', function () { return Serenity.StringEditor; }], ['ProductTypeDescription', function () { return Serenity.StringEditor; }], ['PaymentPlanTypeDescription', function () { return Serenity.StringEditor; }], ['ArmTypeDescription', function () { return Serenity.StringEditor; }], ['RateIndexTypeDescription', function () { return Serenity.StringEditor; }], ['LoanManagerName', function () { return Serenity.StringEditor; }], ['BoardedBy', function () { return Serenity.StringEditor; }], ['BoardedDate', function () { return Serenity.DateEditor; }], ['BoardingTypeDescription', function () { return Serenity.StringEditor; }], ['CreditTypeDescription', function () { return Serenity.StringEditor; }], ['MersMinNumber', function () { return Serenity.StringEditor; }], ['LoanStatusCode', function () { return Serenity.StringEditor; }], ['LoanSubStatusCode', function () { return Serenity.StringEditor; }], ['LoanServicerSkey', function () { return Serenity.IntegerEditor; }], ['InvestorSkey', function () { return Serenity.IntegerEditor; }], ['LoanPoolSkey', function () { return Serenity.IntegerEditor; }], ['ProductTypeSkey', function () { return Serenity.IntegerEditor; }], ['PaymentPlanType', function () { return Serenity.IntegerEditor; }], ['ArmType', function () { return Serenity.StringEditor; }], ['RateIndexTypeSkey', function () { return Serenity.IntegerEditor; }], ['LoanManagerId', function () { return Serenity.StringEditor; }], ['BoardingType', function () { return Serenity.StringEditor; }], ['CreditType', function () { return Serenity.StringEditor; }], ['Filler', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(LoanSearchResultsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsRow;
        (function (LoanSearchResultsRow) {
            LoanSearchResultsRow.idProperty = 'Loan_Skey';
            LoanSearchResultsRow.nameProperty = 'Original_Loan_Number';
            LoanSearchResultsRow.localTextPrefix = 'Reversequest.LoanSearchResults';
            var Fields;
            (function (Fields) {
            })(Fields = LoanSearchResultsRow.Fields || (LoanSearchResultsRow.Fields = {}));
            ['Loan_Skey', 'Original_Loan_Number', 'Fha_Case_Number', 'Prior_Servicer_Loan_Number', 'Investor_Loan_Number', 'Loan_Status', 'Loan_Sub_Status', 'Borrower_First_Name', 'Borrower_Last_Name', 'Coborrower_First_Name', 'Coborrower_Last_Name', 'Borrower_Phone_Number', 'Enbs_First_Name', 'Enbs_Last_Name', 'Property_Address1', 'Property_Address2', 'Property_City', 'Property_County', 'Property_State', 'Property_ZipCode', 'Servicer_Name', 'Investor_Name', 'Loan_Pool_Description', 'Product_Type_Description', 'Payment_Plan_Type_Description', 'Arm_Type_Description', 'Rate_Index_Type_Description', 'Loan_Manager_Name', 'Boarded_By', 'Boarded_Date', 'Boarding_Type_Description', 'Credit_Type_Description', 'Mers_Min_Number', 'Loan_Sub_Status_Code', 'Loan_Servicer_Skey', 'Investor_Skey', 'Loan_Pool_Skey', 'Product_Type_Skey', 'Payment_Plan_Type', 'Arm_Type', 'Rate_Index_Type_Skey', 'Loan_Manager_Id', 'Boarding_Type', 'Credit_Type', 'Row_Count', 'Loan_Status_Code', 'Filler'].forEach(function (x) { return Fields[x] = x; });
        })(LoanSearchResultsRow = Reversequest.LoanSearchResultsRow || (Reversequest.LoanSearchResultsRow = {}));
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsService;
        (function (LoanSearchResultsService) {
            LoanSearchResultsService.baseUrl = 'Reversequest/LoanSearchResults';
            var Methods;
            (function (Methods) {
            })(Methods = LoanSearchResultsService.Methods || (LoanSearchResultsService.Methods = {}));
            ['Retrieve', 'List'].forEach(function (x) {
                LoanSearchResultsService[x] = function (r, s, o) { return Q.serviceRequest(LoanSearchResultsService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = LoanSearchResultsService.baseUrl + '/' + x;
            });
        })(LoanSearchResultsService = Reversequest.LoanSearchResultsService || (Reversequest.LoanSearchResultsService = {}));
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
...
(function (ReverseQuest) {
    ...
    })(ScriptInitialization = ReverseQuest.ScriptInitialization || (ReverseQuest.ScriptInitialization = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Common;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: ReverseQuest.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = ReverseQuest.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: ReverseQuest.Authorization.userDefinition.DisplayName,
...
(function (ReverseQuest) {
    ...
    (function (BasicSamples) {
        ...
        }(ReverseQuest.Common.BulkServiceAction));
...
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsDialog = (function (_super) {
            __extends(LoanSearchResultsDialog, _super);
            function LoanSearchResultsDialog() {
                var _this = _super.apply(this, arguments) || this;
                _this.form = new Reversequest.LoanSearchResultsForm(_this.idPrefix);
                return _this;
            }
            LoanSearchResultsDialog.prototype.getFormKey = function () { return Reversequest.LoanSearchResultsForm.formKey; };
            LoanSearchResultsDialog.prototype.getIdProperty = function () { return Reversequest.LoanSearchResultsRow.idProperty; };
            LoanSearchResultsDialog.prototype.getLocalTextPrefix = function () { return Reversequest.LoanSearchResultsRow.localTextPrefix; };
            LoanSearchResultsDialog.prototype.getNameProperty = function () { return Reversequest.LoanSearchResultsRow.nameProperty; };
            LoanSearchResultsDialog.prototype.getService = function () { return Reversequest.LoanSearchResultsService.baseUrl; };
            return LoanSearchResultsDialog;
        }(Serenity.EntityDialog));
        LoanSearchResultsDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], LoanSearchResultsDialog);
        Reversequest.LoanSearchResultsDialog = LoanSearchResultsDialog;
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var ReverseQuest;
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsEditor = (function (_super) {
            __extends(LoanSearchResultsEditor, _super);
            function LoanSearchResultsEditor(container) {
                return _super.call(this, container) || this;
            }
            LoanSearchResultsEditor.prototype.getColumnsKey = function () { return 'Reversequest.LoanSearchResults'; };
            LoanSearchResultsEditor.prototype.getDialogType = function () { return Reversequest.LoanSearchResultsEditorDialog; };
            LoanSearchResultsEditor.prototype.getLocalTextPrefix = function () { return Reversequest.LoanSearchResultsRow.localTextPrefix; };
            return LoanSearchResultsEditor;
        }(ReverseQuest.Common.GridEditorBase));
        LoanSearchResultsEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], LoanSearchResultsEditor);
        Reversequest.LoanSearchResultsEditor = LoanSearchResultsEditor;
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var ReverseQuest;
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsEditorDialog = (function (_super) {
            __extends(LoanSearchResultsEditorDialog, _super);
            function LoanSearchResultsEditorDialog() {
                var _this = _super.apply(this, arguments) || this;
                _this.form = new Reversequest.LoanSearchResultsForm(_this.idPrefix);
                return _this;
            }
            LoanSearchResultsEditorDialog.prototype.getFormKey = function () { return Reversequest.LoanSearchResultsForm.formKey; };
            LoanSearchResultsEditorDialog.prototype.getLocalTextPrefix = function () { return Reversequest.LoanSearchResultsRow.localTextPrefix; };
            LoanSearchResultsEditorDialog.prototype.getNameProperty = function () { return Reversequest.LoanSearchResultsRow.nameProperty; };
            return LoanSearchResultsEditorDialog;
        }(ReverseQuest.Common.GridEditorDialog));
        LoanSearchResultsEditorDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], LoanSearchResultsEditorDialog);
        Reversequest.LoanSearchResultsEditorDialog = LoanSearchResultsEditorDialog;
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
var ReverseQuest;
(function (ReverseQuest) {
    var Reversequest;
    (function (Reversequest) {
        var LoanSearchResultsGrid = (function (_super) {
            __extends(LoanSearchResultsGrid, _super);
            function LoanSearchResultsGrid(container) {
                var _this = _super.call(this, container) || this;
                _this.nextId = 1;
                return _this;
            }
            LoanSearchResultsGrid.prototype.getColumnsKey = function () { return 'Reversequest.LoanSearchResults'; };
            LoanSearchResultsGrid.prototype.getDialogType = function () { return Reversequest.LoanSearchResultsDialog; };
            //protected getIdProperty() { return LoanSearchResultsRow.idProperty; }
            LoanSearchResultsGrid.prototype.getIdProperty = function () { return "__id"; };
            LoanSearchResultsGrid.prototype.getLocalTextPrefix = function () { return Reversequest.LoanSearchResultsRow.localTextPrefix; };
            LoanSearchResultsGrid.prototype.getService = function () { return Reversequest.LoanSearchResultsService.baseUrl; };
            LoanSearchResultsGrid.prototype.onViewProcessData = function (response) {
                response = _super.prototype.onViewProcessData.call(this, response);
                // alert(response);
                //there is no __id property in CustomerGrossSalesRow but 
                //this is javascript and we can set any property of an object
            ...
            return LoanSearchResultsGrid;
        }(Serenity.EntityGrid));
        LoanSearchResultsGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], LoanSearchResultsGrid);
        Reversequest.LoanSearchResultsGrid = LoanSearchResultsGrid;
    })(Reversequest = ReverseQuest.Reversequest || (ReverseQuest.Reversequest = {}));
})(ReverseQuest || (ReverseQuest = {}));
//# sourceMappingURL=ReverseQuest.Web.js.map